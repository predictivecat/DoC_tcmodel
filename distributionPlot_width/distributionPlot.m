...
if opt.addBoxes
    if isHistogram
        ...
        try
            ...
            bh = boxplot(ah,boxMat,'labels',opt.xValues,'color','k','orientation',ori,'plotstyle','traditional', 'widths', 0.2,'symbol','+','jitter',0);
%             bh = boxplot(ah,boxMat,'labels',opt.xValues,'colorgroup',[1 2 ],'orientation',ori,'plotstyle','traditional', 'widths', 0.075,'symbol','o','jitter',0);
%             bh = boxplot(ah,boxMat,'labels',opt.xValues,'colorgroup',[1 2],'orientation',ori,'plotstyle','compact',     'widths', 0.075,'symbol','ko','jitter',0);
